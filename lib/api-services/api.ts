...
export const getBoxDetails = async (id: string): Promise<BoxDetailsI> => {
  try {
    ...
    const fakeBoxDetails: BoxDetailsI = {
      ...
      instruction:
        'Ласкаво просимо на сторінку, де ваша твор- чість запалюється , а натхнення вибухає на повну ! Тут ви знайдете наші захоплюючі бокси для створення своїх власних шедев- рів свічок. Ми підготували для вас набори, які містять все необхідне: відбір найкращих матеріалів до вимоги у виборі дизайну.  ',
      description:
